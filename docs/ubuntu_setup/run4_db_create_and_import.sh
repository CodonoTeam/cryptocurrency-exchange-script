...
# ============================================
# Codono Exchange - Database Creation & Import
# Creates database, imports SQL, sets admin credentials
# ============================================

set -e

# Read MySQL credentials from /opt/credentials.yml
...
# Use standard Ubuntu MariaDB binary path
...
echo "Codono Database setup and updates complete."
echo "Please visit https://${DOMAIN}/install_check.php and https://${DOMAIN}/"
